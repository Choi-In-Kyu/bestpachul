      ...
      <?php endif; ?>
        <table>
          ...
          <?php else: ?>
              <!--콜 유형에 따른 필터링-->
              <tr>
                  <td><label class="form-switch">유료<br><input type="checkbox" name="charged[]"
                                                              value="<?php echo $chargedCondition ?>"><i></i></label>
                  </td>
                  <td><label class="form-switch">무료<br><input type="checkbox" name="charged[]"
                                                              value="<?php echo $freeCondition ?>"><i></i></label></td>
                  <td><label class="form-switch">포인트<br><input type="checkbox" name="charged[]"
                                                               value="<?php echo $pointCondition ?>"><i></i></label>
                  </td>
              </tr>
              <!--고정 유무에 따른 필터링-->
              <tr>
                  <td><label class="form-switch">일반<br><input type="checkbox" name="fixed[]"
                                                              value="<?php echo $unfixedCondition ?>"><i></i></label>
                  </td>
                  <td><label class="form-switch">고정<br><input type="checkbox" name="fixed[]"
                                                              value="<?php echo $fixedCondition ?>"><i></i></label></td>
                  <td><label class="form-switch">월급<br><input type="checkbox" name="fixed[]"
                                                              value="<?php echo $monthlyCondition ?>"><i></i></label>
                  </td>
              </tr>
              <tr>
