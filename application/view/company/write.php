                    ...
                    <div class="tr">
                        <div class="td">
                            ...
                            <input type="text" name="company-companyName" size="20" required autofocus
                                   value="<?php echo $this->companyList[0]['companyName']; ?>">
                        </div>
                        <div class="td">
                            대표자명
                            ...
                            <datalist id="ceoList" class="input-field">
                              <?php foreach ($this->ceoList as $key => $data): ?>
                                  <option value="<?php echo $data['ceoID'] ?>"> (<?php echo $data['ceoName'] ?>)
                                  </option>
                              <?php endforeach ?>
                            </datalist>
                        </div>
                        <div class="td">
                            ...
                            <input type="text" list="businessTypeList" name="company-businessType" size="20" required
                                   value="<?php echo $this->companyList[0]['businessType']; ?>">
                    ...
                    <div class="tr">
                        <div class="td">
                            ...
                            <input type="text" name="company-companyPhoneNumber" size="20" required
                                   value="<?php echo $this->companyList[0]['companyPhoneNumber']; ?>">
                        </div>
                        <div class="td">
                            사장 전화
                    ...
                    <div class="tr">
                        <div class="td">
                            ...
                            <input type="text" list="addressList" name="company-address"
                                   value="<?php echo $this->companyList[0]['address']; ?>">
                        ...
                        <div class="td">
                            ...
                            <input type="text" name="company-detailAddress" size="20" required
                                   value="<?php echo $this->companyList[0]['detailAddress']; ?>">
                        </div>
                    </div>
                    <div class="tr">
                        <div class="td">
                            ...
                            <input type="text" name="company-grade" size="20" required
                                   value="<?php echo $this->companyList[0]['detail']; ?>">
                        </div>
                        <div class="td">
                            비고
