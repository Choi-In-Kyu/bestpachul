...
<div class="board_list scroll_list right auto-center" style="overflow: hidden">
    ...
    <div class="inline" style="width: 15%; height: 100%;">
        ...
        <div>
            ...
            <form action="" method="post"><input type="hidden" name="filter" value="today"><input class="full_width filterBtn" type="submit" value="오늘"></form>
            <form action="" method="post"><input type="hidden" name="filter" value="week"><input class="full_width filterBtn" type="submit" value="이번주"></form>
            <form action="" method="post"><input type="hidden" name="filter" value="month"><input class="full_width filterBtn" type="submit" value="이번달"></form>
...
<script>
    <?php if(in_array($this->param->page_type,['company','employee'])):?>
        $('.board_list.scroll_list').css('height','600px');
    <?php endif;?>
