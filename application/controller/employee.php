<?php
  ...
  Class Employee extends Controller
  {
    ...
    {
      $deadlineArray = $this->db->getColumnList($this->db->getList($this->deadlineCondition, null, $this->deadlineJoin, $this->deadlineGroup), 'employeeID');
    ...
    {
      $this->db->executeSQL("UPDATE join_employee SET activated = 0 WHERE endDate < CURDATE()");
      $today = date("Y-m-d");
      foreach ($list as $key => $value) {
